 ...
 * http://blog.csdn.net/u010466329/article/details/79046497
 */
public class HttpClientUtils {
    ...
    public static void main(String[] args) {
       ...
       /** HttpClientUtils.getInstance().download(
                "https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=MSFT&interval=1min&apikey=7WB1UUKGC1EG46BL&datatype=csv", "d:/date.csv",
        ...
        // GET 同步方法
        HttpClientUtils s =new HttpClientUtils();
       s.httpGet("https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=MSFT&interval=1min&apikey=7WB1UUKGC1EG46BL&datatype=csv");
